...
public class Demon : MonoBehaviour
{
    ...
    //creo que este metodo lo deberíamos quitar del update ya que ahora le pasamos el
    //turista desde el level manager
    
     public void LookingForTourist()
    {
        ...
        if (lm.tourists.Count > 0)
        {
            ...
            {
                Attack(); //ir a casa sin hacer nada porque no quedan turistas que secuestrar
            }
